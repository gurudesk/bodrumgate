...
export default defineComponent({
    components: { TitleBar, SidebarMenu, Head, Link, PsLabel, PsIcon, PsButton, SetDefaultVendorCurrencyModal},
    props: [
        "title",
        'firebaseConfig',
        'status',
    ...
    watch:{
        currentVendorId(newValue, oldValue){
            if(this.$page.props.currencyId == null){
