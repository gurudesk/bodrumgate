...
<template>
    <Head :title="$t('core_vendor__item_detail')" />
    <ps-layout>
                        ...
                        <div class="grid xxl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
                            <div class="grid gap-6">
                                ...
                                <div class="md:me-6 sm:me-0" v-for="(coreField, index) in coreFieldFilterSettings.filter((coreField) => coreField.original_field_name === 'category_id' && coreField.enable === 1 && coreField.is_delete === 0)" :key="index">
                                    ...
                                    <ps-dropdown :disabled="true" align="left" class="lg:mt-2 mt-1 w-full">
                                        <template #select>
                                            <ps-dropdown-select :disabled="true" :placeholder="$t(coreField.placeholder)" :showCenter="true" :selectedValue="$t(form.category_id)" />
                                        </template>
                                    </ps-dropdown>
                                </div>
                                <!-- end category -->
...
export default defineComponent({
        ...
        breadcrumb() {
            return [
                ...
                },
                {
                    ...
                    url: route('vendor_item.index')
                },
                {
                    label: trans('core_vendor__item_detail'),
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(route('vendor_item.index'));
        },
    },
})
</script>
