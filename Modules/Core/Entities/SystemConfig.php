...
class SystemConfig extends Model
{
    ...
    protected $fillable = ['id', 'lat', 'lng', 'is_approved_enabled', 'is_sub_location', 'is_sub_subscription', 'is_paid_app', 'free_ad_post_count', 'is_block_user', 'max_img_upload_of_item', 'ad_type', 'promo_cell_interval_no', 'one_day_per_price', 'added_date', 'added_user_id', 'updated_date', 'updated_user_id', 'updated_flag'];
