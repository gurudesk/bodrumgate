...
class FrontendSettingService extends PsService
{
    ...
    public function update($id, $request)
    {
        if(isset($request->frontendColors)){
            ...
            $frontend_setting->google_playstore_url = $request->google_playstore_url;
            $frontend_setting->app_store_url = $request->app_store_url;
            $frontend_setting->facebook_url = $request->facebook_url;
            $frontend_setting->linkedin_url = $request->linkedin_url;
            $frontend_setting->twitter_url = $request->twitter_url;
            $frontend_setting->instagram_url = $request->instagram_url;
            $frontend_setting->pinterest_url = $request->pinterest_url;
            $frontend_setting->youtube_url = $request->youtube_url;
            // $frontend_setting->facebook_setting = $request->facebook_setting;
            // $frontend_setting->linkedin_setting = $request->linkedin_setting;
            // $frontend_setting->twitter_setting = $request->twitter_setting;
            // $frontend_setting->instagram_setting = $request->instagram_setting;
            // $frontend_setting->pinterest_setting = $request->pinterest_setting;
            // $frontend_setting->youtube_setting = $request->youtube_setting;
            $frontend_setting->gps_enable = $request->gps_enable;
            $frontend_setting->show_main_menu = $request->show_main_menu;
            $frontend_setting->show_special_collections = $request->show_special_collections;
            $frontend_setting->show_featured_items = $request->show_featured_items;
