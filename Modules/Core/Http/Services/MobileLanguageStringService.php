...
//        $mobile_language = MobileLanguage::findOrFail($request->language_id);
    ...
    public function importJson($languageId, $request){
    ...
    public function importCSV($languageId, $request){
        ...
        $language = $language = MobileLanguage::where($this->mobileLangIdCol, $languageId)->first();
        $import = new MobileLanguageStringImport($language);
