...
{
    protected $coreKeyIdCol, $coreKeysIdCol,$coreKeyNameCol, $coreKeyDescriptionCol, $publish, $unPublish, $middleCoreKeyCode, $coreKeyCounterService;
