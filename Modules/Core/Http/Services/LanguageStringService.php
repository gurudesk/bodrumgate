...
class LanguageStringService extends PsService
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $backend_languages = Language::where("id","<>",$request->language_id)->get();
    ...
    public function getCategoryLanguageString($id = null, $key = null, $languageId = null, $categoryId = null){
        $categoryLanguageStrings = CategoryLanguageString::when($id,function ($q, $id){
                                            ...
                                            ->first();
        return $categoryLanguageStrings;
    }
...
//        }
    ...
    public function updateLanguageStrings($request){
        ...
        try {
            ...
            foreach ($values as $langString){
                ...
                // print_r($languageString->value);
                // print_r($langString['value']);
                // print_r($defaultLanguageString);
                // exit;
                ...
                $category_lang_str = CategoryLanguageString::where(CategoryLanguageString::languageId, $langString['language_id'])->get();
    ...
    public function generateDefaultLanguageString($values){
        $defaultLang = Language::where('status', 1)->first();
    ...
    public function storeCategoryLanguageStrings($request, $key, $categoryId){
        ...
        try {
            ...
            foreach ($values as $langString){
                $languageString = $this->getCategoryLanguageString(null, $key,$langString['language_id'], $categoryId);
                if($languageString){
                    $languageString->value = $langString['value'];
                    $languageString->added_user_id = Auth::user()->id;
                    $languageString->update();
                }else{
                    $languageString = new CategoryLanguageString();
                    $languageString->category_id = $categoryId;
    ...
    public function storeLanguageStrings($request, $key){
        ...
        try {
            ...
            foreach ($values as $langString){
                $languageString = $this->getLanguageString(null, $key,$langString['language_id']);
                if($languageString){
                    $languageString->value = $langString['value'];
                    $languageString->added_user_id = Auth::user()->id;
                    $languageString->update();
    ...
    public function importCSV($languageId, $request){
        ...
        $category_lang_str = CategoryLanguageString::where(CategoryLanguageString::languageId, $language->id)->get();
        $lang_str = array_merge($lang_str->toArray(), $category_lang_str->toArray());
        generateLangStrJson($fileName, $lang_str);
