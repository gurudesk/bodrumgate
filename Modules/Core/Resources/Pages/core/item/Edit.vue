    ...
    <ps-layout>
        ...
        $t('core__be_edit_item_lbl') }}</ps-label-header-6>
                ...
                <div class='flex flex-col w-full mb-8 mt-2'
                    ...
                    <ps-label-header-6 class="px-4 mt-4" textColor="text-secondary-300 dark:text-secondary-100">{{
        ...
        $page.props.product_relation_errors[custom_field_header.core_keys_id]
    }}</ps-label-caption>
                                    </div>
                                </div>
                                <!-- quantity -->
        ...
        errors.description }}</ps-label-caption>
                                ...
                                <div v-if="selected_price_type === PsConst.NORMAL_PRICE">
                                    <div class="md:me-6 sm:me-0"
                                        ...
                                        <ps-label-caption v-if="coreField.mandatory = 1" textColor="text-red-500 "
                                            class="mt-2 block">{{
        errors.percent }}</ps-label-caption>
                                    </div>
                                </div>
