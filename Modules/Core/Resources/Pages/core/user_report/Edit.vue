                        ...
                        <div class="grid w-full sm:w-1/2 gap-6">
                            ...
                            <div>
                                ...
                                <div v-if="user.user_cover_photo" class="flex items-end pt-4">
                                    <img v-lazy=" { src: $page.props.uploadUrl + '/' + user.user_cover_photo, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_profile.png' }" class="w-96 h-auto" :alt="$t(core__be_user_cover_photo)" />
