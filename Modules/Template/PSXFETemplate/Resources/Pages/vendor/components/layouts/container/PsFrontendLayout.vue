...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    ...
    <div  class="  w-full h-full flex flex-col min-h-screen ">
        ...
        <ps-nav-bar :topOfPage="atTopOfPage" :uploadSetting="$page.props.backendSetting.upload_setting"/>
        </div>
...
export default defineComponent({
  ...
  props:['authUser','backendSetting','firebaseConfig','webPushKey', 'appUrl', 'isUserDeleted', 'uploadSetting'],
    setup(props) {
        ...
        watch(() => props.isUserDeleted, (newValue, oldValue) => {
            if(newValue){
