<template>
    <input
        ...
        :disabled="disabled"
        :readonly="readonly"
        :class="disabled ? [ opacity,rounded,disabledTheme, ] : isError ? [theme, rounded, , errorBorder, opacity] : [theme, rounded, defaultBorder, opacity, focus]"
        :maxlength="maxlength"
...
export default {
    ...
    props: {
        ...
        "defaultBorder": { type: String, default: "border border-feSecondary-200 hover:border-feSecondary-400 dark:border-feSecondary-400 hover:dark:border-feSecondary-50" },
        "focus": { type: String, default: "focus:outline-none focus:border-none focus:ring-2 focus:ring-fePrimary-300 ring-fePrimary-300 placeholder-feSecondary-500 dark:placeholder-feSecondary-400" },
