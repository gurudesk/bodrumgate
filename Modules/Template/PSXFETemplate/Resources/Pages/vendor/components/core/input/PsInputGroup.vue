<template>
    ...
    <div class="flex flex-row " :class="[background ]">
        ...
        <input
        class="flex-grow block w-full text-sm shadow-sm border border-none placeholder-feSecondary-500"
        :type="type"
        :value="value"
        :disabled="disabled"
...
export default {
    ...
    props: {
        ...
        "padding" : { type: String, default: "px-4 py-3" },
        "type" : { type: String, default: "text" },
        "theme" : { type: String, default : "dark:bg-feAchromatic-800 text-feSecondary-500 dark:text-feSecondary-400" },
