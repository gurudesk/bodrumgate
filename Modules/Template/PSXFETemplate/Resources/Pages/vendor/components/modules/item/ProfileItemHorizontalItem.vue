            ...
            <div class="lg:px-0 lg:py-0 px-1 py-1" :class="showProfile ? 'rounded-b-xl lg:rounded-b-2xl ' : 'rounded-xl lg:rounded-2xl'">
                <div class="h-44 relative z-0">
                    ...
                    <div class="absolute left-2 bottom-2  z-20">
                        <ps-label v-if="item && item.isSoldOut == '1' && appInfoStore?.isSoldOutFeatureSettingOn()" class="py-1 px-2 text-sm rounded bg-fePrimary-500 font-medium " textColor="text-feAchromatic-50 ">{{ $t('item_horizontal_item__sold_out') }}</ps-label>
                    </div>
