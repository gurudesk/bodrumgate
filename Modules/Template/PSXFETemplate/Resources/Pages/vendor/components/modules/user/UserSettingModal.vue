<template>
    ...
    <password-update-modal v-if="showPasswordUpdateModal" ref="password_update_modal" />
...
const PasswordUpdateModal = defineAsyncComponent(() => import('@template1/vendor/components/modules/password/PasswordUpdateModal.vue'));
...
export default defineComponent({
    ...
    setup() {
        ...
        async function openPasswordUpdate() {
            showPasswordUpdateModal.value = true;
            await PsUtils.waitingComponent(password_update_modal);
