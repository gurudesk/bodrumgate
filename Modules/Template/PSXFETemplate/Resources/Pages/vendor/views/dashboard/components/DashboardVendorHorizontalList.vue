<template>
    <div v-if="vendorSearchStore.vendorSearchList?.data?.length != 0 && vendorSearchStore.vendorSearchList?.data?.length != null" class="xl:w-feLarge lg:w-large md:w-full md:px-6 lg:px-0 mx-auto mt-5 mb-10">
