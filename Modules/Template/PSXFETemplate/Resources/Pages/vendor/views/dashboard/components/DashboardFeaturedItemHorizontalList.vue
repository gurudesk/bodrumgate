<template>
     <div class="xl:w-feLarge lg:w-large md:w-full md:px-6 lg:px-0 mx-auto mt-5 mb-10">
            <!-- Start feature items -->
            <div
                class="bg-feSecondary-50 dark:bg-feAchromatic-900 flex flex-col sm:flex-row justify-between gap-8 sm:gap-5 px-4 py-6 sm:p-10">
