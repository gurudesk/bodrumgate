...
<template>
    <div class="mt-5 mb-10  xl:w-feLarge lg:w-large md:w-full md:px-6 lg:px-0 mx-auto bg-feSecondary-800" v-if="packageStore.hasData()">
            <div class=" flex flex-col sm:flex-row justify-between gap-8 sm:gap-5 px-4 py-6 sm:p-10">
