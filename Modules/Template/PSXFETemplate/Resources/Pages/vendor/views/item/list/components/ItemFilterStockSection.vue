<template>
    <div class="w-full flex flex-col">
        ...
        <div v-if="spaceWrap" class="sm:block md:flex flex-col w-full text-sm font-medium ">
            <ps-radio v-for=" selectData  in soldOutItem.filter((itm)=>itm.isShow == true)" :key="selectData.id" :value="selectData"
...
export default {
    ...
    setup(props) {
        ...
        const soldOutItem = ref([{
                id: "", name:"All", isShow: true,
            },
            {
                id: "0", name: "Available", isShow: true,
            },
            {
                id: "1", name: "Sold out", isShow: true,
            }]);

        watch(()=>props.isSoldOutFeatureSettingOn,(newValue, oldValue)=>{
            soldOutItem.value[2].isShow = newValue;
        });
        ...
        onMounted( () => {
            soldOutItem.value[2].isShow = props.isSoldOutFeatureSettingOn;
