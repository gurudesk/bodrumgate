<template>
    ...
    <div class="bg-feSecondary-50 dark:bg-feSecondary-800 rounded-lg px-2 py-4 lg:p-4 mt-6"
        v-if="productRelation.length > 0 || isSoldOutFeatureSettingOn">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6" >
            ...
            <div class="" v-if="isSoldOutFeatureSettingOn">
                <ps-label
                    textColor="text-base font-medium text-feSecondary-800 dark:text-feSecondary-50">{{
    ...
    <div class="mt-6 px-2 py-4 lg:p-4 rounded-lg bg-feSecondary-50 dark:bg-feSecondary-800">
        ...
        <div class="mt-6">
            <ps-label textColor="text-sm font-normal text-feSecondary-600 whitespace-pre-line dark:text-feSecondary-200">
    ...
    <div class="col-span-8 mt-6">
        <div class="bg-feSecondary-50 dark:bg-feSecondary-800 rounded-lg px-2 py-4 lg:p-4 flex flex-col">
            ...
            <div v-for="productRelation in productStore.item?.data?.productRelation.filter((pr) => pr.coreKeysId != 'ps-itm00002' && pr.coreKeysId != 'ps-itm00004' && pr.coreKeysId != 'ps-itm00007' && pr.coreKeysId != 'ps-itm00046')"
                :key="productRelation.id">
                <div v-if="productRelation.isVisible == '1' && productRelation.isDelete == '0'">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-1 whitespace-pre-line h-full">
