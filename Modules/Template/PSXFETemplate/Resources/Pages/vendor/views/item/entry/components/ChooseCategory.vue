<template>
    ...
    <div v-if="categoryStore.itemList?.data != null" class="mt-8 grid md:grid-cols-2 sm:grid-cols-1 gap-4">
      <div v-for="category in categoryStore.itemList.data" :key="category.catId" class="p-3">
        <div class="w-full h-62 bg-feSecondary-50 dark:bg-feAchromatic-900 p-6 relative flex items-center rounded-lg border-2 border-transparent hover:border-fePrimary-500 cursor-pointer"
